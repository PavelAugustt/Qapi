...
def get_timeheap():
    try:
        ...
        app.logger.error("Timeheap file not found.")
        return jsonify({"error": "Timeheap file not found"}), 404
    except json.JSONDecodeError:
        app.logger.error("Invalid JSON in timeheap file.")
...
def instruct_llm():
    ...
    try:
        ...
        app.logger.exception("An error occurred while calling the Gemini API.")
